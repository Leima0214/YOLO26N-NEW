...
| 3 | official P2 + EMA-P3-factor8 + BiFPN | P2 Detect head; EMA before P3 Detect; neck merges use identity-initialized weighted concat | detail + attention + weighted fusion |
...
6. SEAttention at P3
7. CBAM at P3
8. BiFPN (`Concat_bifpn`, initialized as ordinary concat)
