...
The completed A2 smoke passed those gates. The full validation assignment scan in `paper1_a2_assignment_summary.md` found normal D10 positive assignment but substantially lower candidate CIoU as aspect ratio increased. A2 is therefore authorized for one protocol-matched 30e signal; do not start B1, B2, a composite, or a 100e run in parallel.
