...
def write_model(filename, options, generator_name):
    ...
    if not isinstance(generator_name, str) or not re.fullmatch(r"[A-Za-z0-9_]+\.py", generator_name):
    ...
    try:
        ...
        validate(temporary, bool(options.get("p2")))
