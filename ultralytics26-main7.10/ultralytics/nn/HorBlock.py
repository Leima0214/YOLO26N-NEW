...
def drop_path(x, drop_prob: float = 0., training: bool = False):
    ...
    output = x.div(keep_prob) * random_tensor#详细改进流程和操作，请关注B站博主：Ai学术叫叫兽 er,畅享一对一指点迷津，已指导无数家人拿下学术硕果！！！
    return output
...
class GlobalLocalFilter(nn.Module):
    ...
    def forward(self, x):
        ...
        x2 = x2 * weight
        x2 = torch.fft.irfft2(x2, s=(a, b), dim=(2, 3), norm='ortho')#详细改进流程和操作，请关注B站博主：Ai学术叫叫兽 er,畅享一对一指点迷津，已指导无数家人拿下学术硕果！！！
